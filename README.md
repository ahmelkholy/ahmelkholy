...
### Islanding Scenarios for Highly Reliable Operation in Distribution Networks
...
### Impact of Large Wind Energy Penetration on Electric Power Systems
...
<details open>
  ...
  <br />
  <ul>
    <li>Elkholy, A., et al. "<i>Comprehensive Study of the Impact of Unbalanced Loading on Power Losses and Voltage Quality in Distribution Systems</i>." 2024 IEEE 25th International Conference of Young Professionals in Electron Devices and Materials (EDM).</li>
    <li>Elkholy, A., et al. "<i>Design and Implementation of an Arc Suppression Device for Single Line to Ground Faults in Power Systems</i>." 2023 24th International Middle East Power Systems Conference (MEPCON).</li>
  </ul>
