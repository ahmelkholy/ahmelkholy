...
* **Islanding Scenarios for High Reliable Operation in Distribution Networks (2017 – 2019)**
    Modeled smart microgrid intentional islanding and power system stability. Designed DG controllers to mitigate distribution network blackouts by dynamically supplying stable loads during grid isolation.
* **Impact of Large Wind Energy Penetration on Electric Power Systems (2013 – 2014)**
    Utilized ETAP and K-Mean clustering on the IEEE 30 Bus system to optimize wind turbine locations, simultaneously minimizing losses and enhancing voltage profiles and system stability.
...
<details open>
  ...
  <br>
  <ul>
    <li>Elkholy, A., et al. (2024). "<i>Comprehensive Study of the Impact of Unbalanced Loading on Power Losses and Voltage Quality in Distribution Systems</i>." 2024 IEEE 25th International Conference of Young Professionals in Electron Devices and Materials (EDM).</li>
    <li>Elkholy, A., et al. (2024). "<i>Design and Implementation of an Arc Suppression Device for Single Line to Ground Faults in Power Systems</i>." 2023 24th International Middle East Power System Conference (MEPCON).</li>
  </ul>
...
## 🏆 Honors & Awards
  ...
  * **The Foreign Mission Envoys Winner** - Scholarship from the Ministry of Higher Education
